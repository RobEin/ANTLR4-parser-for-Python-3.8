...
### About files:
 - PythonParser.g4
   is the ANTLR4 parser grammar that based on the official [Python grammar](https://docs.python.org/3.8/reference/grammar.html). This was the last traditional Python grammar not yet written in [PEG](https://en.wikipedia.org/wiki/Parsing_expression_grammar).
